...
/**
 * The main program. modified by Huihui Yang in March 2010.
 */
...
public class LicenseChecker{
	 ...
	 * 
	 */
	public void processPackage(String licensePath) {
		...
		if(licenseDatabase == null)
			buildLicenseDatabase(licensePath);
	 ...
	 */
	public void buildLicenseDatabase(String licensePath) {
		...
		licenseDatabase = new LicenseDatabase(licensePath);
	...
	public static void doExcludePaths(LicenseChecker lc) {
